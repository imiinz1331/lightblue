...
testManWalking =
    let env = []
        ...
        expected = [
            ([UJudgement env (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S")))) (UD.Con (T.pack "entity"))], -- π1π1S : entity
             [UJudgement env (UD.Proj UD.Snd (UD.Proj UD.Fst (UD.Con (T.pack "S"))))  -- π2π1S : man(π1π1S)
              (UD.App (UD.Con (T.pack "man")) (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S"))))),
              UJudgement env (UD.Proj UD.Snd (UD.Con (T.pack "S"))) -- π2S : walk(π1π1S)
              (UD.App (UD.Con (T.pack "walk")) (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S")))))])
          ]
        traceResult = trace ("Result: " ++ show result) result
        traceExpected = trace ("Expected: " ++ show expected) expected
...
testManEnteredWhistled =
    let env = []
        -- 1文目: A man entered.
        term1 = UD.Con (T.pack "S1")
        type1 = UD.Sigma
                    (UD.Sigma
                        (UD.Con (T.pack "entity"))
                        (UD.App (UD.Con (T.pack "man")) (UD.Var 0)))
                    (UD.App (UD.Con (T.pack "enter")) (UD.Proj UD.Fst (UD.Var 0)))

        -- 2文目: He whistled.
        term2 = UD.Con (T.pack "S2")
        type2 = UD.App
                    (UD.Con (T.pack "whistle"))
                    (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S1"))))

        result = getJudgements env [(term1, type1), (term2, type2)]

        expected = [
            -- 1文目の結果
            ([UJudgement env (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S1")))) (UD.Con (T.pack "entity"))],
             [UJudgement env (UD.Proj UD.Snd (UD.Proj UD.Fst (UD.Con (T.pack "S1")))) (UD.App (UD.Con (T.pack "man")) (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S1"))))),
              UJudgement env (UD.Proj UD.Snd (UD.Con (T.pack "S1"))) (UD.App (UD.Con (T.pack "enter")) (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S1")))))]),
            -- 2文目の結果
            ([],
             [UJudgement env (UD.Con (T.pack "S2")) (UD.App (UD.Con (T.pack "whistle")) (UD.Proj UD.Fst (UD.Proj UD.Fst (UD.Con (T.pack "S1")))))])
          ]
